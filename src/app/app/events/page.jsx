    ...
    <div className="min-h-screen bg-gray-50 p-6 font-sans space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="p-5 border-b border-gray-100 flex flex-col lg:flex-row justify-between items-center gap-4">
          <h2 className="text-xl font-bold text-gray-900 w-full lg:w-auto">Events</h2>
          
          <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
            {/* Filter Buttons Group */}
            <div className="flex gap-2 w-full sm:w-auto">
               <Button variant="outline" className="h-10 text-gray-600 gap-2 bg-white flex-1 sm:flex-none">
                <Filter size={16} />
                Filter By
              </Button>
               <Button variant="outline" className="h-10 text-gray-600 gap-2 bg-white flex-1 sm:flex-none">
            ...
            {/* Add Event Button */}
            <Button className="h-10 bg-gray-900 text-white hover:bg-black gap-2 shadow-sm w-full sm:w-auto">
              Add Event
              <Plus size={16} />
            </Button>
          </div>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-gray-50/50 hover:bg-gray-50/50 border-gray-100">
                <TableHead className="font-bold text-gray-900 pl-6 h-12">Event Name</TableHead>
                <TableHead className="font-bold text-gray-900 h-12">Category</TableHead>
                <TableHead className="font-bold text-gray-900 h-12 w-[300px]">Description</TableHead>
                <TableHead className="font-bold text-gray-900 h-12 whitespace-nowrap">Date</TableHead>
                <TableHead className="font-bold text-gray-900 h-12 whitespace-nowrap">Time</TableHead>
                <TableHead className="font-bold text-gray-900 h-12">Location</TableHead>
                <TableHead className="font-bold text-gray-900 h-12">Facilitator(s)</TableHead>
                <TableHead className="font-bold text-gray-900 h-12 pr-6 text-right">Status</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {eventsData.map((event) => (
                <TableRow key={event.id} className="hover:bg-gray-50/50 border-gray-100 transition-colors">
        ...
        <div className="p-4 border-t border-gray-100 flex items-center justify-center">
            <div className="flex items-center gap-2">
                <button className="px-3 py-1.5 text-xs font-medium text-gray-500 hover:text-gray-900 disabled:opacity-50">Previous</button>
                <button className="w-8 h-8 flex items-center justify-center text-xs font-medium bg-gray-900 text-white rounded-lg shadow-sm">1</button>
                <button className="w-8 h-8 flex items-center justify-center text-xs font-medium text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">2</button>
                <button className="w-8 h-8 flex items-center justify-center text-xs font-medium text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">3</button>
                <button className="w-8 h-8 flex items-center justify-center text-xs font-medium text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">4</button>
                <button className="px-3 py-1.5 text-xs font-medium text-gray-500 hover:text-gray-900">Next</button>
            </div>
        </div>
