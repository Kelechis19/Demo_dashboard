...
// Removed next/link to prevent dependency errors in this environment
 import Link from "next/link"; 

// UPDATED IMPORT: Using relative path to ensure resolution
...
export default function YouthsEnrolledPage() {
  ...
  const [selectedYouth, setSelectedYouth] = React.useState(null);
        ...
        <div className="p-5 border-b border-gray-100 flex flex-col lg:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
            ...
            <div className="flex gap-2">
              ...
              {/* Replaced Next.js Link with simple anchor or wrapper div */}
              <div className="contents">
                <Link href="/app/youths-enrolled/youth.id"><Button className="h-10 bg-gray-900 text-white hover:bg-gray-800 gap-2">
                  Add New Youth
                  <Plus size={16} />
                </Button></Link>
              </div>
              ...
              {youthData.map((youth, i) => (
                ...
                >
                  ...
                  <TableCell className="text-right pr-6">
                    <button
                      onClick={() => handleUpdateClick(youth)}
